package com.taskmanagement.app.modules.employeelogin.`data`.model

import com.taskmanagement.app.R
import com.taskmanagement.app.appcomponents.di.MyApp
import kotlin.String

data class EmployeeLoginModel(
  /**
  ...
  var txtLanguageOne: String? =
      MyApp.getInstance().resources.getString(R.string.msg_new_to_tasklink)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtLanguageTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_or_login_with)
